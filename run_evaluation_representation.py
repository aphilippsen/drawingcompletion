...
# either test across all testing conditions: this determines which inference data are used for learning the PCA mapping
test_hyp_all = ['0.01', '0.1', '1', '10', '100']
...
for curr_r in range(len(dir_list)):
    ...
    print('---------------------------------------' + str(np.mean(inner_distances_is_clusters)))
